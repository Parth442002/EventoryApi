    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('media', models.FileField(blank=True, null=True, upload_to='eventImages/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bannerImg', models.ImageField(blank=True, null=True, upload_to='tagBanner/')),
                ('posterImg', models.ImageField(blank=True, null=True, upload_to='tagPoster/')),
            ],
        ),
        migrations.CreateModel(
            name='Event',
            fields=[
                ...
                ('tags', models.ManyToManyField(blank=True, to='events.tags')),
            ],
        ),
    ]
